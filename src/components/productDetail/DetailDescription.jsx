  ...
  return (
    <div className=" w-full px-10 lg:w-[75%] mx-auto my-3 py-8 flex flex-col gap-3">
      <div className=" gap-8 flex items-center justify-center p-4 font-montserrat border-b border-b-[#ECECEC]">
        <div className="font-semibold cursor-pointer leading-6 tracking-[0.2px] text-[#737373] dark:text-[#fafafa] p-2">
          Description
        </div>
        <div className="font-semibold cursor-pointer leading-6 tracking-[0.2px] dark:text-[#fafafa] text-[#737373] p-2">
          Additional Information
        </div>
        <div className="font-semibold cursor-pointer leading-6 tracking-[0.2px] dark:text-[#fafafa] text-[#737373] p-2 flex items-center gap-1">
          Reviews
      ...
      <div className=" flex flex-col mt-8 lg:flex lg:flex-row gap-8 font-montserrat">
        ...
        <div className="lg:w-1/3 w-full flex flex-col gap-6 ">
          ...
          <p className="font-medium text-sm leading-5 tracking-[0.2px] text-[#737373] dark:text-[#c2c2c2]">
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-2">
              <div className="flex items-center gap-2">
                <IoIosArrowForward className="w-5 h-5 text-[#737373] dark:text-[#c2c2c2]" />
                <span className="font-bold text-sm leading-6 tracking-[0.2px] text-[#737373] dark:text-[#c2c2c2]">
